...
## 🇬🇷 Proof of Escape — Μάθε Blockchain μέσα από την Απόδραση!

### 🔍 Τι είναι το Proof of Escape;

Το **Proof of Escape** είναι μια παιγνιοποιημένη Web3 πρόκληση quiz, όπου οι φοιτητές αλληλεπιδρούν με ένα πραγματικό blockchain δίκτυο (Besu QBFT) για να:  
- Λύσουν κουίζ και γρίφους  
- Υποβάλουν απαντήσεις με keccak256 hash  
- Κερδίσουν on-chain ανταμοιβές ως ESCAPE tokens  
- Διεκδικήσουν ένα περιορισμένο NFT μετά την πλήρη ολοκλήρωση  
...
- Εξερευνάτε συναλλαγές smart contracts και on-chain κατάσταση  
- Μαθαίνετε θεμελιώδεις έννοιες blockchain μέσα από καθοδηγούμενα κουίζ  
...
3. Κάντε εγγραφή και ξεκινήστε να λύνει τα κουίζ  
4. Χρησιμοποιήστε το ενσωματωμένο hash εργαλείο για keccak256 υπολογισμούς  
...
Για να αλληλεπιδράσετε με την εφαρμογή Proof of Escape, θα χρειαστείτε δοκιμαστικά tokens (EDU-D) στο δίκτυο QBFT_Besu_EduNet. Αυτά καλύπτουν τα έξοδα συναλλαγών.  
...
Μετά την ολοκλήρωση όλων των κουίζ, μπορείτε να κάνετε mint ένα ειδικό Proof of Escape NFT. Αυτό αποτελεί σήμα διάκρισης και θα χρησιμοποιηθεί σε μελλοντικές φάσεις του παιχνιδιού.  
